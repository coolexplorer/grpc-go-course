...
type SqrtRequest struct {
	...
	Numher int32 `protobuf:"varint,1,opt,name=numher,proto3" json:"numher,omitempty"` // could be uint32
}
...
func (x *SqrtRequest) GetNumher() int32 {
	if x != nil {
		return x.Numher
	}
	return 0
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x68, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x68, 0x65, 0x72, 0x22,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x6f, 0x6c, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72,
